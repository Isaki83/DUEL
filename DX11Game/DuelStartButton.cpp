...
＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞*/
CDuelStartButton::CDuelStartButton(CScene* pScene) : CButton(pScene)
{
	m_id = GOT_BUTTON_DUEL_START;
}
...
HRESULT CDuelStartButton::Init()
{
	...
	// 変数初期化
	//＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	m_fPos = XMFLOAT2(0.0f, -285.0f);
	m_fSize = XMFLOAT2(280.0f, 70.0f);
...
void CDuelStartButton::Draw()
{
	...
	// 文字
	//＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	CPolygon::SetTexture(m_pTexture[TEX_WORD_DUEL_START]);
