...
＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞＞*/
CStartButton::CStartButton(CScene* pScene) : CButton(pScene)
{
	m_id = GOT_BUTTON_START;
}
...
void CStartButton::Draw()
{
	...
	CPolygon::SetSize(m_fSize.x * 0.25f, m_fSize.y);
	...
	// 文字
	//＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	CPolygon::SetTexture(m_pTexture[TEX_WORD_START]);
